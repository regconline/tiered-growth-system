...
const tierConfig = {
  basic: { label: "Basic", badgeClass: "tier-basic-badge", borderClass: "tier-basic-border", bgClass: "tier-basic-bg", icon: "🟢" },
  standard: { label: "Standard", badgeClass: "tier-standard-badge", borderClass: "tier-standard-border", bgClass: "tier-standard-bg", icon: "🟡" },
  premium: { label: "Premium", badgeClass: "tier-premium-badge", borderClass: "tier-premium-border", bgClass: "tier-premium-bg", icon: "🔴" },
};

const TierCard = ({ tier, name, price, includes, result }: TierCardProps) => {
